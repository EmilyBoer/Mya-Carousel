;(function( $ ) {
    ...
    $.verticalSlider = function( sectionsContainer, options ) {
        ...
        var defaults = {
            ...
            infoSelector: '.carousel-container',
        ...
        var _construct = function() {
            ...
            // Register Velocity effectsno-js
        ...
        var _updateInfoClasses = function( section ) {
            ...
            if (section.index() == 0){
                ...
                $('.purple-fixed-1 ').css("opacity", "1");
                $('.text-group').fadeOut(10);
                $('.text-group').fadeIn(10);
                $('#i-1').css("background-color", "white");
                $('#i-2').css("background-color", "transparent");
                $('#i-3').css("background-color", "transparent");
                $('#i-4').css("background-color", "transparent");
            ...
            if (section.index() == 1){
                console.log(section.index());
                $('.purple-fixed-1 ').css("opacity", "0");
                $('.purple-fixed-2 ').css("opacity", "1");
                $('.text-group').fadeOut(10);
                $('.text-group').fadeIn(10);
                $('#i-2').css("background-color", "white");
                $('#i-1').css("background-color", "transparent");
                $('#i-3').css("background-color", "transparent");
                $('#i-4').css("background-color", "transparent");
                console.log(section.index());
            }
                ...
                console.log(section.index());
                $('.purple-fixed-2 ').css("opacity", "0");
                $('.purple-fixed-3 ').css("opacity", "1");
                $('.text-group').fadeOut(10);
                $('.text-group').fadeIn(10);
                $('#i-3').css("background-color", "white");
                $('#i-2').css("background-color", "transparent");
                $('#i-1').css("background-color", "transparent");
                $('#i-4').css("background-color", "transparent");
                 console.log(section.index());
                ...
                $('.purple-fixed-3 ').css("opacity", "0");
                $('.purple-fixed-4 ').css("opacity", "1");
                $('.text-group').fadeOut(10);
                $('.text-group').fadeIn(10);
                $('#i-4').css("background-color", "white");
                $('#i-3').css("background-color", "transparent");
                $('#i-2').css("background-color", "transparent");
                $('#i-1').css("background-color", "transparent");
            ...
            if( section.index() === Plugin.sectionsNumber - 1 ) {
                ...
                // add code taking body height out of css
            }
        };
        ...
        var _bindEvents = function() {
            ...
            if( Modernizr.touch ) {
                ...
                // Swipe gesture
                var hammerVS = new Hammer($('.carousel-container')[0], {
                    threshold: 1
                });
